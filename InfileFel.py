...
class fel_dte:
    ...
    def certificar_xml(self, xml_firmado, anulacion , clave_unica):      
      ...
      llave_certificacion ="1B79941F079202DED3697B86BF8576A4"
      usuario="34390138_PRODU"
      nit_emisor = "34390138"
      correo_copia = 'correo@demo.com'
      data = {
            "nit_emisor":nit_emisor, 
        "correo_copia":correo_copia, 
        "xml_dte":xml_firmado } 
      pro=str("Guzman")+str("2026")
      headers = { 
                 'usuario': usuario ,
                 'llave': llave_certificacion ,
                 'identificador': str(uuid.uuid4())+str(pro),#como q es nit
                }
